...
rect. Windows, and Linux for the placement and framing flags (see below);
...
**On Linux** (`model_viewer_handle_vk_linux`) `--transparent`, `--rect`, `--pose` and `--margin` follow
...
The viewer registers `HKCU\Software\Classes\displayxr-view` on **every**
