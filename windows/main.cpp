...
static void OpenLoadDialog(HWND hwnd) {
    ...
    if (g_xr != nullptr && g_xr->pfnRequestFilePickerEXT != nullptr &&
        ...
        strncpy(info.filters[0].extensions, "*.glb;*.gltf;*.stl;*.obj",
    ...
    ofn.hwndOwner = hwnd;
    ofn.lpstrFilter = "3D Models (*.glb;*.gltf;*.stl;*.obj)\0*.glb;*.gltf;*.stl;*.obj\0glTF (*.glb;*.gltf)\0*.glb;*.gltf\0STL (*.stl)\0*.stl\0OBJ (*.obj)\0*.obj\0All Files (*.*)\0*.*\0";
