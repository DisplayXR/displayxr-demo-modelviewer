...
// v1 ships the demo's bundled sample.glb (same asset the macOS/Windows legs
// use). Double-tap re-frames it. Additional models can be added here with
// their assets/ filenames (+ license attribution) in a follow-up.
